...
public class Predator : MonoBehaviour
{
    Vector3 size;
    float mess;
    float vision_depth, vision_angle, idleVelocity, chaseVelocity, topAccelerity;
    float energy;
    Vector3 current_position, current_velocity, current_orientation;
...
public class Predator : MonoBehaviour, ILandAnimal
{
    ...
    void Start()
    {
>>>>>>> 8d7f166478773cb1e1796c253d2a8bccfaec0ed5
